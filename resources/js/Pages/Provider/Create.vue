<template>
    <Dialog
        v-model:visible="providerStore.createModal"
    ...
    >
        <div class="flex flex-col gap-4">
            ...
            <div class="flex justify-end gap-2">
                <Button label="Cancel" severity="secondary" @click="providerStore.closeCreate" />
...
const submit = async () => {
  try {
    await providerStore.createProvider(toast);
  } catch (err) {
