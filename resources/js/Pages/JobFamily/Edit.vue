<template>
    <Dialog
        v-model:visible="jobFamilyStore.showEditModal"
        header="Edit Job Family"
        modal
        :closable="false"
    ...
    >
        <div class="flex flex-col gap-4">
            ...
            <div class="flex justify-end gap-2">
                <Button label="Cancel" severity="secondary" @click="jobFamilyStore.closeEdit" />
...
const submit = async () => {
  try {
    await jobFamilyStore.updateJobFamily(toast);
  } catch (err) {
